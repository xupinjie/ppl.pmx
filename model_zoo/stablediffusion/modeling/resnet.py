...
class ResnetBlock2D(nn.Module):
    ...
    def __init__(
        ...
        self.layer_id = ResnetBlock2D.layer_id
        ResnetBlock2D.layer_id+=1
...
class Downsample2D(nn.Module):
    ...
    def forward(self, hidden_states, scale: float = 1.0):
        ...
        if self.use_conv and self.padding == 0:
            ...
            hidden_states = PMX.padding(hidden_states, pad, mode="constant", value=0)
    ...
    def forward(self, hidden_states, output_size=None, scale: float = 1.0):
        ...
        if self.use_conv:
            if self.name == "conv":
                ...
                if isinstance(self.Conv2d_0, nn.Conv2d):
